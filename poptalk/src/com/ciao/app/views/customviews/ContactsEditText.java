...
public class ContactsEditText extends MultiAutoCompleteTextView {
    ...
    private void init(Context context) {
        ...
        BitmapFactory.decodeResource(context.getResources(),R.drawable.user_avtar, options);
        options.inSampleSize = Utils.calculateInSampleSize(options, mDropdownItemHeight,
                mDropdownItemHeight);
        options.inJustDecodeBounds = false;
        mLoadingImage = BitmapFactory.decodeResource(context.getResources(),R.drawable.user_avtar, options);
    ...
    protected CharSequence convertSelectionToString(Object selectedItem) {
        return ((Contact) selectedItem).name;
    }
   ...
   /* public class Contact {
    ...
    private class ContactsAdapter extends CursorAdapter {
        ...
        public Object getItem(int position) {
            ...
            contact.name = cursor.getString(ContactsQuery.DISPLAY_NAME_COLUMN);
        ...
        public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
            ...
            holder.image = (CircularImageView) dropdownView.findViewById(android.R.id.icon);
