...
public class CropUtil {
    ...
    public static int getExifRotation(File imageFile) {
        ...
        try {
            ...
            Integer OrientationValue = exif.getAttributeInt(ExifInterface.TAG_ORIENTATION, ExifInterface.ORIENTATION_UNDEFINED);
            switch (OrientationValue) {
                ...
                case ExifInterface.ORIENTATION_ROTATE_270: {
                    ...
                    break;
                default: {
                    rtn_val = ExifInterface.ORIENTATION_UNDEFINED;
                }
                    break;
            }
        } catch (IOException e) {
