 ...
 */
public class ChangeCiaoNumberAsyncTaskLoader extends AsyncTaskLoader<String> implements BaseLoader {
    ...
    public ChangeCiaoNumberAsyncTaskLoader(RequestBean mRequestBean) {
    ...
    public String loadInBackground() {
        mRespronse=NetworkCall.getInstance(mRequestBean.getActivity()).hitNetwork(AppNetworkConstants.UPDATE_CIAO_NUMBER,jsonObject);
