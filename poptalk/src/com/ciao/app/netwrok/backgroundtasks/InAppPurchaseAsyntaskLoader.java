 ...
 */
public class InAppPurchaseAsyntaskLoader extends AsyncTaskLoader<String> implements BaseLoader{
    ...
    public InAppPurchaseAsyntaskLoader(RequestBean mRequestBean) {
